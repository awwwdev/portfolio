    ...
    <>
      ...
      <div className="mt-20 toolkit__grid">
        ...
        <ul className="display-contents">
          ...
          <Li className="col-span-2  bg-sky3 light " src="/tool-logos/react.svg" alt="React" />
          <Li
          ...
          <Li className="bg-violet-100 col-span-2 row-span-3" src="/tool-logos/astrojs.svg" alt="Astro" size="w-5/10" />
          <Li
          ...
          />
          <Li
            className="col-span-2 row-span-2 bg-gradient-to-r from-gray-300 to-slate-300"
