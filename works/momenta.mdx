...
<div className="flex flex-wrap  gap-4 ">
  <img src="/momenta/m1.png" alt="Coloe Pallet Option 1" className="rd-xl w-10" />
  <img src="/momenta/m2.png" alt="Coloe Pallet Option 2" className="rd-xl w-10" />
  <img src="/momenta/m3.png" alt="Coloe Pallet Option 3" className="rd-xl w-10" />
  <img src="/momenta/m4.png" alt="Coloe Pallet Option 4" className="rd-xl w-10" />
  <img src="/momenta/m5.png" alt="Coloe Pallet Option 5" className="rd-xl w-10" />
  <img src="/momenta/m6.png" alt="Coloe Pallet Option 6" className="rd-xl w-10" />
</div>
