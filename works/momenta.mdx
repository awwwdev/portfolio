...
<div className="grid  gap-4 " style={{gridTemplateColumns: "repeat( auto-fit, minmax(min(100%, 12rem), 1fr) )"}}>
  <img src="/momenta/m1.png" alt="Coloe Pallet Option 1" className="rd-xl" />
  <img src="/momenta/m2.png" alt="Coloe Pallet Option 2" className="rd-xl"/>
  <img src="/momenta/m3.png" alt="Coloe Pallet Option 3" className="rd-xl"/>
  <img src="/momenta/m4.png" alt="Coloe Pallet Option 4" className="rd-xl"/>
  <img src="/momenta/m5.png" alt="Coloe Pallet Option 5" className="rd-xl"/>
  <img src="/momenta/m6.png" alt="Coloe Pallet Option 6" className="rd-xl"/>
</div>
...
<img src="/momenta/desk.png" alt='a small desk to work when you are sitting on the ground' className='rd-xl' />
