...
## A Landing page two weeks after landing a new city



<br/>
<a className="btn-prm" href="https://momenta.app" target="_blank"> Visit Momenta's Landing page</a>
<br/>
...
<div className="flex flex-wrap  gap-4 ">
  <img src="/momenta/m1.png" alt="Coloe Pallet Option 1" className="rd-lg w-10" />
  <img src="/momenta/m2.png" alt="Coloe Pallet Option 2" className="rd-lg w-10" />
  <img src="/momenta/m3.png" alt="Coloe Pallet Option 3" className="rd-lg w-10" />
  <img src="/momenta/m4.png" alt="Coloe Pallet Option 4" className="rd-lg w-10" />
  <img src="/momenta/m5.png" alt="Coloe Pallet Option 5" className="rd-lg w-10" />
  <img src="/momenta/m6.png" alt="Coloe Pallet Option 6" className="rd-lg w-10" />
</div>
