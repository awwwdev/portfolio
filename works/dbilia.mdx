---
title: "DBILIA, Refactored the Unreadable"
date: "2023-02-03"
---

<br />
<a className="btn-prm" href="https://dbilia.com" target="_blank"> Visit DBILIA</a>
...
I did some, or maybe a fair amount of Graphic Design. Although, It was not part of my job description, but when my supervisoer apprached me first before he search for a freelance Designer, I liked to do some designing after a while coding. So, we created a bunch cool visuals for DBILIA in diffenrt stages of the project. Some of them you can see below.

I redesigned the logo, to have a modern look.

<img src="/dbilia/logo.png" alt="redesigned DBILIA logo" className="rd-xl" />

I created some NFT collections for DBILIA. They turned out so cute!

<figure>
  <video src="/dbilia/cutlery-club.mp4" autoplay="" playsinline="" muted="" className="rd-xl" />
  <figcaption classNames="text-sm text-center c-gray11">Cutlery Club</figcaption>
</figure>

<br />

<figure>
  <video src="/dbilia/square-heads.mp4" autoplay="" playsinline="" muted="" className="rd-xl" />
  <figcaption classNames="text-sm text-center c-gray11"> Square Heads</figcaption>
</figure>
