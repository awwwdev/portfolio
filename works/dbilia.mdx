...
This project was challenging ones to me, especially right after the graduating from my bootcamp. But definietly empowered my reafctoring muscles and proved how a well refactored code base can easilly be changed to meet new requirements.
...
<video alt='Responsiveness' src='/dbilia/responsive.mp4' controls muted controlList='nodownload nofullscreen' >
</video>
