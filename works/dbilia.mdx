...
<figure>
  <video src="/dbilia/trello-bugs.mp4" autoplay="" playsinline="" muted="" className="rd-xl" />
  <figcaption classNames="text-sm text-center c-gray11">The bugs I listed in a Trello board</figcaption>
</figure>
...
<img alt="redesign" src="/dbilia/redesign.png" className="rd-xl" />
...
<img alt="redesign" src="/dbilia/redesign2.png" className="rd-xl" />
...
<video
  ...
  playsinline
  muted
  controlList="nodownload nofullscreen"
  className="rd-xl"
></video>
...
<div className="p-4 py-32 rd-xl  flex ac jc " style={{minHeihgt: "15rem", background: "linear-gradient(90deg , #333 , #111)"}}>
  <img src="/dbilia/logo.png" alt="redesigned DBILIA logo" className="" style={{maxWidth: "15rem"}} />
</div>
{/* 
I created some NFT collections for DBILIA. They turned out so cute!

<div className='grid gap-4 ' style={{gridTemplateColumns: "repeat( auto-fit, minmax(min(100%, 12rem), 1fr) )"}}>
<figure>
  <video src="/dbilia/cutlery-club.mp4" autoplay="" playsinline="" muted="" className="rd-xl aspect-ratio-1/1" style={{aspectRatio: "1/1"}}/>
  <figcaption classNames="text-sm c-gray9 text-center c-gray11 block mt-2">Cutlery Club</figcaption>
</figure>
<figure>
  <video src="/dbilia/square-heads.mp4"  autoplay=""  playsinline="" muted="" className="rd-xl aspect-ratio-1/1"  style={{aspectRatio: "1/1"}} />
  <figcaption classNames="text-sm c-gray9 text-center c-gray11 block mt-2"> Square Heads</figcaption>
</figure>
</div> */}
