...
export const shortcuts: UserShortcuts = [
  ...
  [
    /^bf-i-(.*)$/,
    ([, iconName]) =>
      `before:opacity-50 before:mie-2 empty:before:mie-0 before:vertical-middle before:scale-120 before:-translate-y-0.5  before:content-none before:inline-block before:i-${iconName}`,
  ],
  [
    /^af-i-(.*)$/,
    ([, iconName]) =>
